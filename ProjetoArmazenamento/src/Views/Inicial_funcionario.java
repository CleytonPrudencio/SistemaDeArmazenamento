...
public class Inicial_funcionario extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					Inicial_funcionario frame = new Inicial_funcionario();
		         ...
		         String descri = descricao.getText().toString();
				  ...
				  try {
			            ...
			            // JOptionPane.showMessageDialog(null, nome + marca + garantia + descricaoimagem + quantidade + valorferramenta + descri);
			             ...
			             Logger.getLogger(Inicial_funcionario.class.getName()).log(Level.SEVERE, null, ex);
			         }
